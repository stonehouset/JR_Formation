...
<div class="panel-body" id="body_interface_apprenant">
    ...
    @if($dateNow < $dateFinForm)
        <h4 style="color: white;text-align: center;margin-top: 2%;">Revenez le {{ Carbon\Carbon::parse($dateFinForm)->format('d/m/Y') }}  pour répondre aux questionnaires!</h4>
    @else
    ...
    <div id="form_satisfaction_formateur">  
        @if($apprenant->questionnaire_formateur == 0)                
        ...
        <div id="form_satisfaction_formation">
            @if($apprenant->note_formation == null)
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <ul class="list-group">
                                ...
                                <input id="note_formation" type="number" class="form-control" required name="note_formation" value="" min="0" max="20" required style="margin-top: 1%;width: 50%;margin-left: auto;margin-right: auto;" placeholder="/20">
                            </ul>
    ...
    <div class="row" id="form_com_semaine_apprenant" style="margin-top: 2%;">
        <div class="offset-lg-3 col-lg-6 col-md-12"> 
            ...
            @elseif($dateNow > $datePlus4Jours and $apprenant->commentaire_semaine1 == null) 
            ...
            @endif
            @if($dateNow < $datePlusOnzeJours and $apprenant->commentaire_semaine1 != null )
                <h4 style="color: white;text-align: center;">Revenez le {{Carbon\Carbon::parse($datePlusOnzeJours)->format('d/m/Y')}} pour remplir votre deuxieme commentaire!</h4>
            
            @elseif($dateNow > $datePlusOnzeJours and $apprenant->commentaire_semaine1 != null and $apprenant->commentaire_semaine2 == null)     
            ...
            @endif
            @if($apprenant->commentaire_semaine2 != null and $apprenant->commentaire_semaine1 != null)
